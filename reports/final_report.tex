...
\item \textbf{Nuh Al Sharafi:} morphological feature analysis; hybrid ensemble exploration; model experiments and tuning; Subtask~2 development and stacking; evaluation, literature review.
\item \textbf{Ali Khaled A. Ishtay Altamimi:} EDA; visualization; error analysis; report figures.
\item \textbf{Hussein MH Nasser:} AraGPT2 for subtasks 2 and 3; prompt engineering; EDA for subtasks 2 and 3; literature review.
\end{itemize}
